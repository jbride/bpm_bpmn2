...
Of interest to this exercise is the work item handler called:  com.redhat.gpe.refarch.bpm_signalling.processtier.StartWaitState.
These workItemHandler classes need to be placed on the java classpath of BPM Suite 6.
